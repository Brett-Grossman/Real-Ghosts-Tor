...
const ViewAllProperties = () => {
    ...
    return (
        <div className='container shadow-lg' style={{backgroundColor: '#f0f0f0'}}>
            ...
            <div className="col-md">
            <div className="subcontainer position-fixed" style={{height: '', width: '400px' ,backgroundColor: '#f0f0f0', border: '2px solid black', left: '52%', transform: 'translateX(50%)'}}>
                ...
                <p className="offset-sm-1">Asking Price</p>
                    <form onSubmit={functionToSetAskingPrice}>
                        ...
                        <input className="col-sm-3" id="minimum_asking_price" type="number" name="minimum_asking_price" value={potentialMinimumAskingPrice} onChange={minimumAskingPriceChangehandler}/>
                        <label htmlFor="maximum_asking_price">Max:</label>
                        <input className="col-sm-3" id="maximum_asking_price" type="number" name="maximum_asking_price" value={potentialMaximumAskingPrice} onChange={maximumAskingPriceChangeHandler}/>
                        <button >Submit</button>
                    </form>
                    <button className="offset-sm-1" onClick={() => resetAskingPrice()}>Reset</button>
                    </div>
                    <div>
                        <p className="offset-sm-1">For Sale Or For Rent</p>
                        <button className="offset-sm-1" onClick={setSellOrRentToSell}>For Sale</button>
                        <button onClick={setSellOrRentToRent}>For Rent</button>
                        <button className="offset-sm-1" onClick={() => resetSellOrRent()}>Reset</button>
                    </div>
                    <p></p>
                    ...
                    <form onSubmit={setSquareFootage} className="offset-sm-1">
                        ...
                        <input className="col-sm-2" id="minimum_square_footage" type="number" name="minimum_square_footage" value={potentialMinSquareFootage} onChange={minimumSquareFootageChangeHandler}/>
                        <label htmlFor="maximum_square_footage">Max:</label>
                        <input className="col-sm-2" id="maximum_square_footage" type="number" name="maximum_square_footage" value={potentialMaxSquareFootage} onChange={maximumSquareFootageChangeHandler}/>
                        <button>Submit</button>
                    </form>
                    <button onClick={() => resetSquareFootage()} className="offset-sm-1">Reset</button>
                    </div>
                    ...
                    <div>
                        <p className="offset-sm-1">Beds</p>
                            <form onSubmit={bedFilterSubmissionHandler} className="offset-sm-1">
                                ...
                                <input className="col-sm-1" id="minimum_beds" type="number" name="minimum_beds" value={potentialMinNumberOfBeds} onChange={minimumBedsChangeHandler}/>
                                <label htmlFor="maximum_beds">Max:</label>
                                <input className="col-sm-1" id="maximum_beds" type="number" name="maximum_beds" value={potentialMaxNumberOfBeds} onChange={maximumBedsChangeHandler}/>
                                <button>Submit</button>
                            </form>
                        <button className="offset-sm-1" onClick={() => resetBedFilter()}>Reset</button>
            </div>
            ...
            <div>
                ...
                <form onSubmit={bathFilterSubmissionHandler}>
                    ...
                    <input className="col-sm-1" id="minimum_baths" type="number" name="minimum_baths" value={potentialMinNumberOfBaths} onChange={potentialMinimumBathsChangeHandler}/>
                    <label htmlFor="maximum_baths">Max:</label>
                    <input className="col-sm-1" id="maximum_baths" type="number" name="minimum_baths" value={potentialMaxNumberOfBaths} onChange={potentialMaximumBathsChangeHandler}/>
                    <button>Submit</button>
                </form>
                <button className="offset-sm-1" onClick={resetBathFilter}>Reset</button>
            </div>
            ...
            <div>
                ...
                <form onSubmit={ghostFilterSubmissionHandler}>
                    ...
                    <input className="col-sm-1" id="minimum_ghosts" type="number" name="minimum_ghosts" value={potentialMinNumberOfGhosts} onChange={potentialMinimumGhostsChangeHandler}/>
                    <label htmlFor="maximum_ghosts">Max:</label>
                    <input className="col-sm-1" id="maximum_ghosts" type="number" name="maximum_ghosts" value={potentialMaxNumberOfGhosts} onChange={potentialMaximumGhostsChangeHandler}/>
                    <button>Submit</button>
                </form>
                <button className="offset-sm-1" onSubmit={() => resetGhostFilter()}>Reset</button>
            </div>

            <div>
                <button className="col-sm-4 offset-sm-4" onClick={() => resetAllFilters()}>Reset All</button>
            </div>
                </div>
            </div>
            </div>
